 ...
 */
@RestController
public class StorageController implements StorageService {
    ...
    public String echo(@PathVariable(value = "commodityCode") String commodityCode, @PathVariable(value = "count") int count) {
